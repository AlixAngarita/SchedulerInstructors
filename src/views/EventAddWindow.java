...
public class EventAddWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        spinnerEndDate.setEditor(new JSpinner.DateEditor(spinnerEndDate, model.toPattern()));
    ...
    private void jButtonCreateEventActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreateEventActionPerformed
        ...
        if(this.newEvent) {
           ...
           //update event
            Events events = new Events();
            Event result = events.updateEvent(selectedEventUpdate.getId(), (Date) spinnerStartDate.getValue(), (Date) spinnerEndDate.getValue(), jtextType.getText(), jTextDescription.getText(), jComboInstructor.getSelectedIndex()+1);
            if(result != null) {
                if(result.isOverlap())
